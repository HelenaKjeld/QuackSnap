...
<template>
    <main class="grid place-items-center px-4 py-8">
        <section class="w-full max-w-[520px] rounded-xl border border-white/20 bg-zinc-900/75 p-5">
            ...
            <p class="mb-4 text-zinc-300 opacity-80">Register a new QuackSnap user and send it directly
                to your backend.</p>
            ...
            <form class="grid gap-4" @submit.prevent="onSubmit">
                <label class="grid gap-1.5 font-semibold">
                    ...
                    <input v-model="form.fullName"
                        class="rounded-lg border border-white/20 bg-black/20 px-3 py-2 text-zinc-100" type="text"
